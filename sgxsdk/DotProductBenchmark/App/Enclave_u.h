...
#endif
#ifndef OCALL_DOT_PRODUCT_DEFINED__
#define OCALL_DOT_PRODUCT_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_dot_product, (int* arr1, int* arr2, int* result, size_t cnt));
#endif
